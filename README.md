...
This repository contains all eagle files, gerber files, BOM, descriptions and cable drawings. The main description is contained in teh User Port section.

Depending on where the parts abd pcbs are purchased, the price for the complete harness is less than 20€ (2019).
